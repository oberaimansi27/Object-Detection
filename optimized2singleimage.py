...
img = cv2.imread('C:\\Users\\LENOVO\\Desktop\\project\\mansi\\personball.jpg')
...
for i in result:
    ...
    print(result[index]['label'])
    x=result[index]['label']
    if x=='sports ball':
        t1 = (result[index]['topleft']['x'],result[index]['topleft']['y']) #top lefta
        b1 = (result[index]['bottomright']['x'],result[index]['bottomright']['y']) # bottomright
        labl = result[index]['label']
